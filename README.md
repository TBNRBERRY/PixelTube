# PixelTube
<p>
    <a href="https://github.com/TBNRBERRY/PixelTube/stargazers">
      <img alt="Stars" title="Stars" src="https://img.shields.io/github/stars/TBNRBERRY/PixelTube?style=shield&label=%E2%AD%90%20Stars&branch=main&kill_cache=1%22" />
    </a>
    <a href="https://github.com/TBNRBERRY/PixelTube/releases/latest">
      <img alt="Latest Release" title="Latest Release" src="https://img.shields.io/github/v/release/TBNRBERRY/PixelTube?style=shield&label=%F0%9F%9A%80%20Release">
    </a>
    <a href="hxxps://klausenbusk.github.io/flathub-stats/#ref=TBNRBERRY/PixelTube&interval=infinity&downloadType=installs%2Bupdates">
...
PixelTube is an unofficial wrapper of YouTube Leanback (the console and Smart TV version of YouTube) for Xbox (Sideloaded in Dev Mode), with a built-in adblocker and minor enhancements.
...
PixelTube solves all of this by wrapping it with WinUI & C#, pretending to be the YouTube app, implementing controller *and* touch support, and overall making it a much better experience than just spoofing your user agent.
...
PixelTube has some settings that you can change, which are located directly in the YouTube settings. They can also be opened by pressing `Ctrl+O` on your keyboard or `R3` on your controller.
...
```sh
git clone https://github.com/TBNRBERRY/PixelTube
cd PixelTube
